...
namespace PlazaConnectivityChecker.Views
{
    ...
    /// </summary>
    public partial class NetworkActivity : Page
    {
        ...
        private static IEnumerable<TcpProcessRecord> TcpActiveConnections = null;
        // List of Active UDP Connections.
        private static IEnumerable<UdpProcessRecord> UdpActiveConnections = null;
        ...
        public class TcpProcessRecordCollection : IEnumerable<TcpProcessRecord>
        {
            private readonly List<TcpProcessRecord> _tcpProcessRecords = new List<TcpProcessRecord>();

            public void Add(TcpProcessRecord tcpProcessRecord)
            {
                _tcpProcessRecords.Add(tcpProcessRecord);
            }

            public void AddRange(IEnumerable<TcpProcessRecord> tcpProcessRecords)
            {
                _tcpProcessRecords.AddRange(tcpProcessRecords);
            }

            public IEnumerator<TcpProcessRecord> GetEnumerator()
            {
                return _tcpProcessRecords.GetEnumerator();
            }

            System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            {
                return ((IEnumerable)_tcpProcessRecords).GetEnumerator();
            }
        }

        public class UdpProcessRecordCollection : IEnumerable<UdpProcessRecord>
        {
            private readonly List<UdpProcessRecord> _udpProcessRecords = new List<UdpProcessRecord>();

            public void Add(UdpProcessRecord udpProcessRecord)
            {
                _udpProcessRecords.Add(udpProcessRecord);
            }

            public void AddRange(IEnumerable<UdpProcessRecord> udpProcessRecords)
            {
                _udpProcessRecords.AddRange(udpProcessRecords);
            }

            public IEnumerator<UdpProcessRecord> GetEnumerator()
            {
                return _udpProcessRecords.GetEnumerator();
            }

            System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator()
            {
                return ((IEnumerable)_udpProcessRecords).GetEnumerator();
            }
        }


        public TcpProcessRecordCollection GetAllTcpConnections()
        {
            int bufferSize = 0;
            TcpProcessRecordCollection tcpTableRecords = new TcpProcessRecordCollection();
            ...
            try
            {
                ...
                if (result != 0)
                    return new TcpProcessRecordCollection();
            ...
            var tcp_Query = (from t in tcpTableRecords
                        where t.ProcessName.Contains("Dropbox")
                        select t);

            TcpProcessRecordCollection filteredTcpTableRecords = new TcpProcessRecordCollection();

            foreach (var t in tcp_Query)
            {
                filteredTcpTableRecords.Add(t);
            }

            

            return filteredTcpTableRecords;
        }
        ...
        /// is insufficient memory to satisfy the request.
        /// </exception>
        public UdpProcessRecordCollection GetAllUdpConnections()
        {
            int bufferSize = 0;
            UdpProcessRecordCollection udpTableRecords = new UdpProcessRecordCollection();
            ...
            try
            {
                ...
                // hence empty list is returned to the caller function.
                if (result != 0)
                    return new UdpProcessRecordCollection();
        ...
        /// </summary>
        private void SocketConnection_Load(object sender, System.Windows.RoutedEventArgs e)
        {
        ...
        /// </summary>
        /// 
        System.Windows.Threading.DispatcherTimer tmrDataRefreshTimer = new System.Windows.Threading.DispatcherTimer();
        ...
        private void tscProtocolType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            tmrDataRefreshTimer.Interval = TimeSpan.FromMilliseconds(5000);
            ...
            if (tscProtocolType.SelectedIndex == (int)Protocol.TCP)
            {
                ...
                tslTotalRecords.Content = (tmrDataRefreshTimer.IsEnabled ? "[Capturing active"
                + " connections...]   " : "") + "Total number of TCP connections : " + TcpActiveConnections.Count();
            }
            else if (tscProtocolType.SelectedIndex == (int)Protocol.UDP)
            {
                ...
                tslTotalRecords.Content = (tmrDataRefreshTimer.IsEnabled ? "[Capturing active"
                + " connections...]   " : "") + "Total number of UDP connections : " + UdpActiveConnections.Count();
            }
        }
        ...
        public void tmrDataRefreshTimer_Tick(object sender, EventArgs e)
        {
        ...
        private void gdvConnections_SelectionChanged(object sender, EventArgs e)
        {
            ...
            gdvSocketConnections.UnselectAll();
        }

        /// <summary>
        /// Event handler for ToolStrip StartCapture button click event.
        /// </summary>
        private void tsbStartCapture_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            // Enabling timer object to fire tick events.
            tmrDataRefreshTimer.IsEnabled = true;
        ...
        /// </summary>
        private void tsbStopCapture_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            // Disabling timer object to stop tick events.
            tmrDataRefreshTimer.IsEnabled = false;
            tscProtocolType_SelectedIndexChanged(tscProtocolType, e);
        }
